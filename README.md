...
<div align="center">
<img src="assets/benchmark.png" alt="FileMaster resource profile — CPU, memory, power and process count">
</div>
...
**Requirements.** Indexing, retrieval, OCR, and passage search run on macOS 14+. Written answers use Apple's Foundation Models and need macOS 26 with Apple Intelligence enabled; the framework is weak-linked, so FileMaster runs fine without it.
...
make bundle     # assemble FileMaster.app under build/ (strips symbols, ad-hoc signs)
